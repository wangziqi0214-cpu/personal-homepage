...
针对标注平台使用过程中内容查找繁琐、修改前后差异难以辨认、图片查看不便等问题，我开发了一款浏览器辅助插件，以减少重复操作并提升标注与审核效率。
...
此后，我从事多模态数据工作，进一步积累了对语音场景的判断经验，包括：
...
结合内容运营与多模态数据经验，我希望重点参与以下几类对话数据的设计和构造。
